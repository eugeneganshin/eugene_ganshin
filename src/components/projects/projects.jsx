...
const Projects = () => {
  ...
  const emgithub = (
    <a
      href="https://serene-lowlands-14249.herokuapp.com"
      target="_blank"
      key="emgif"
    >
      <img
  ...
  const emexternal = (
    <a
      href="https://github.com/eugeneganshin/easy-mail.git"
      target="_blank"
      key="emex"
    >
      <img
        id="external_logo"
        alt="external logo"
        src={require("./images/logos/link.png")}
      />
    </a>
  );
  ...
  const utgithub = (
    <a
      href="https://github.com/eugeneganshin/ustours.git"
      target="_blank"
      key="utgif"
    >
      <img
  ...
  const utexternal = (
    <a
      href="https://shielded-hamlet-43748.herokuapp.com"
      target="_blank"
      key="utex"
    >
      <img
  ...
  const burgergithub = (
    <a
      href="https://github.com/eugeneganshin/The-Burger-Builder.git"
      target="_blank"
      key="burex"
    >
      <img
  ...
  const handleGifs = () => {
    const empng = (
      <img
        ...
        alt={altem}
        src={require("./images/easymail/em.png")}
      />
    );
    const emgif = (
      <img
        className="project_picture"
        alt={altem}
        src={require("./images/easymail/em.gif")}
      />
    );
    const utpng = (
      <img
        className="project_picture"
        alt={altut}
        src={require("./images/ustours/ut.png")}
      />
    );
    const utgif = (
      <img
        className="project_picture"
        alt={altut}
        src={require("./images/ustours/ut.gif")}
      />
    );
